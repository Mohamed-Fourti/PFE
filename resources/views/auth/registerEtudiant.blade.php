                    ...
                    <form method="POST" action="{{ route('inscriptionp') }}" >
                        ...
                        <div  class="form-group row show show">
                            ...
                            <div class="fadeIn second">
                                <input id="inputType" type="text" class="form-control @error('cin') is-invalid @enderror" name="cin" @if (!empty($ExcelImport)) value=" {{ $ExcelImport['cin'] }}"     @else value="{{old('cin')}}" @endif readonly autocomplete="cin" >
                        ...
                        <div  class="form-group row show">
                            ...
                            <div class="fadeIn second">
                                <input id="inputType" type="text" class="form-control @error('nom') is-invalid @enderror" name="nom"    @if (!empty($ExcelImport)) value="{{$ExcelImport['nom_fr']}}"     @else value="{{old('nom')}}" @endif  readonly  >
                        ...
                        <div  class="form-group row show">
                            <div class="fadeIn second">
                                <input id="inputType" type="text" class="form-control @error('prenom') is-invalid @enderror" name="prenom"    @if (!empty($ExcelImport)) value="{{$ExcelImport['prenom_fr']}}"     @else value="{{old('prenom')}}" @endif  readonly  >
                        ...
                        <div  class="form-group row show">
                            <div class="fadeIn second">
                                <input id="inputType" type="text" class="form-control @error('class') is-invalid @enderror" name="class"    @if (!empty($ExcelImport)) value="{{ $ExcelImport['class']}}"     @else value="{{old('class')}}" @endif  readonly  >
                            </div>
                        </div>                     
