    ...
    <nav class="main-header navbar navbar-expand navbar-white navbar-light navcolorc">
      ...
      <ul class="navbar-nav">
        ...
        <li class="nav-item d-sm-inline-block">
          ...
          <a class="nav-link" href="{{ route('logout') }}" onclick="event.preventDefault(); this.previousElementSibling.submit();" id="navAdmin">
            @lang('Déconnexion')
          </a>
        </li>
      </ul>
          ...
          <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
            ...
            <li class="nav-item has-treeview {{ menuOpen($elements['children']) }}">
              ...
              <ul class="nav nav-treeview">
                ...
                <x-AdminPanel.menu-item :route="$child['route']" :sub=true>
                  @lang($child['name'])
            ...
            @else
            <x-AdminPanel.menu-item :route="$elements['route']" :icon="$elements['icon']">
              @lang($name)
            </x-AdminPanel.menu-item>
            @endisset
