            ...
            <table id="table_id2" class="table">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td>{{ $data->created_at }}</td>
                  <td>
                    <a class="mr-3" href="{{route('Fiche-De-Vœux.show',$data->id)}}"><i class="fa fa-eye" style="color: green;font-size:20px;"></i></a>
                    <a class="delete mr-3" data-toggle="modal" data-target="#delete" data-id='{{$data->id}}'><i class="fa fa-trash" aria-hidden="true" style="color: red;font-size:20px;"></i></a>
                  </td>
                </tr>
                @endforeach
...
<div id="delete" class="modal fade">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <form method="POST" action="{{ route('Fiche-De-Vœux/deletedemande')}}">
        @csrf
